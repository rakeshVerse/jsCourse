 ...
 * Internal working:
 *
 * String is a primitive data type, we can't call methods on primitives but non-primitives like Object, Array, etc only.
 * However, whenever we call the method on string, JS behind the scenes converts 'string primitive' to 'string object'.
 * And then on that Object the method is called.
 * This process is known as boxing.
 *
 * After operation, JS converts 'string object' back to 'string primitive'.
 */
console.log(new String('hello')); // this is what JS does whenever we call a method on a string
...
// Fix string: first letter uppercase rest lower case
